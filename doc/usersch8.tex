...
\fun{GEN}{MF_get_CHI}{GEN mf} return the nebentypus, which is a special form
 of character structure attached to Dirichlet characters (see next section).
Its values are given as algebraic numbers: either $\pm1$ or \typ{POLMOD}
in $t$.

\fun{GEN}{MF_get_basis}{GEN mf} return the $\Q$-basis of the space.

\fun{long}{MF_get_dim}{GEN mf}

\fun{GEN}{MF_get_eisen}{GEN mf}

\fun{GEN}{MF_get_fields}{GEN mf}

\fun{GEN}{MF_get_newforms}{GEN mf}

\fun{long}{MF_get_space}{GEN mf}
