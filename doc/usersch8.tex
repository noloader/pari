...
\fun{long}{MF_get_N}{GEN mf}

\fun{GEN}{MF_get_basis}{GEN mf}
...
\fun{GEN}{MF_get_gk}{GEN mf}

\fun{long}{MF_get_k}{GEN mf}
...
values will be given as algebraic numbers: either $\pm1$ or \typ{POLMOD}
in $t$.
