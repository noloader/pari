...
\fun{GEN}{MF_get_basis}{GEN mf} return the $\Q$-basis of the space; the forms
have coefficients in $\Q(\chi)$. Low-level version of \kbd{mfbasis}.

\fun{long}{MF_get_dim}{GEN mf} returns the dimension of the space. It
is the cardinality of \tet{MF_get_basis}.

\fun{GEN}{MF_get_eisenstein}{GEN mf} returns a $\Q$-basis for the subspace
...
\fun{GEN}{MF_get_vtf}{GEN mf}

\fun{GEN}{MF_get_M}{GEN mf}

\fun{GEN}{MF_get_Mindex}{GEN mf}

\fun{GEN}{MF_get_Minv}{GEN mf}

\fun{GEN}{MFcusp_get_vMjd}{GEN mf}

\fun{GEN}{MFnew_get_vj}{GEN mf}
...
\fun{long}{mfcuspdim}{long N, long k, GEN CHI}

\fun{long}{mffulldim}{long N, long k, GEN CHI}

\fun{long}{mfnewdim}{long N, long k, GEN CHI}

\fun{long}{mfolddim}{long N, long k, GEN CHI}

\fun{long}{mfeisensteindim}{long N, long k, GEN CHI}
...
\fun{GEN}{mfvecembed}{GEN f, GEN vz}
