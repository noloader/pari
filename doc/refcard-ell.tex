...
Elliptic curve initially given by 5-tuple $v=\kbd{[}a_1,a_2,a_3,a_4,a_6\kbd{]}$
attached to Weierstrass model or simply $\kbd{[}a_4,a_6\kbd{]}$. Must be
converted to an \var{ell} struct.
\hfil\break
...
A hyperelliptic curve is given by a pair $[P,Q]$ ($y^2+Qy = P$, $Q^2+4P$
