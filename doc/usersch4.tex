...
\fun{void}{forqfvec1}{void *E, long (*fun)(void *, GEN, GEN, double), GEN A, GEN BORNE}
goes through the same vectors as \tet{forqfvec(v,A,BORNE,)}, calling
\tet{fun(E, v)} for each vectors \kbd{v}, stopping if \kbd{fun} returns a
nonzero value.
