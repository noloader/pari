...
$1,\dots,9$ (printed as \kbd{t1}, \dots \kbd{t9}), with decreasing
priority.

\subsubsec{User variables}\sidx{variable (user)} When the program starts,
\kbd{x} is the only user variable (number~$0$), numbers $1$ to $9$
(decreasing priority) are reserved for building polynomials with predictable
priorities.
...
\fun{long}{fetch_var_higher}{}\label{se:fetch_var}
