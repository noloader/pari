...
\item \tet{forperm} to loop over permutations of $k$. See the documentation
  ...
  a loop with callbacks:

  \fun{void}{forperm}{void *E, long call(void *, GEN), GEN k}
...
\item \tet{forsubset} to loop over subsets. See the documentation
  ...
  is available as two loops with callbacks:

  \fun{void}{forallsubset}{void *E, long call(void *, GEN), long n}

  \fun{void}{forksubset}{void *E, long call(void *, GEN), long n, long k}

  \noindent The two variants are also available as iterators:

  \fun{void}{forallsubset_init}{forsubset_t *T, long n}

  \fun{GEN}{forallsubset_next}{forsubset_t *T} returns the next subset
  as a \typ{VECSMALL} or \kbd{NULL} when all subsets have been exhausted.

  \fun{void}{forksubset_init}{forsubset_t *T, long n, long k}

  \fun{GEN}{forksubset_next}{forsubset_t *T}
