...
\misctitle{Technical note} The internal precision is actually expressed in
bits and can be viewed and manipulated indifferently via \kbd{realprecision}
(decimal digits, as explained above; shortcut \kbd{\bs p}) or
\kbd{realbitprecision} (bits; shortcup \kbd{\bs ps}).
