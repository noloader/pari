...
It is possible to create such function by using the syntax

  \kbd{(\var{list of formal variables}, \var{var}[..]) -> \var{seq}}

The parameter \var{var} will be substitued by a vector of all the remaining
arguments.
...
? f(1,2,3)
%1 = 6
? sep(s,v[..])=for(i=1,#v,print1(v[i],s));print();
? sep(",",1,2,3)
1,2,3,
@eprog
