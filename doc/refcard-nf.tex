...
\li{create $A/I$, $I$ double-sided ideal}{algquotient$(\var{al},I,\{\fl=0\})$}
\li{create $A_1\otimes A_2$}{algtensor$(\var{al1}, \var{al2})$}
\li{create subalgebra from basis $B$}{algsubalg$(\var{al}, B)$}
\li{subalgebras from orth. central idempotents $e$}
...
\li{\var{al}= $(L/K,\sigma,b)$ cyclic; return $\sigma$}{algaut$(\var{al})$}
\li{\var{al}= $(L/K,\sigma,b)$ cyclic; return $b$}{algb$(\var{al})$}
