...
curves.
Finally the $B_1$ parameter determines the computations performed on the
...
The computation is deterministic for a given parameters. Returns \kbd{NULL}
on failure, else a non trivial factor or \kbd{N}.
