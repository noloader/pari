...
\fun{GEN}{group_to_cc}{GEN G}, where $G$ is a small group
returns a \kbd{cc} (conjclasses) structure \kbd{[elts,conj,rep]}, as obtained
by \kbd{alggroupcenter}, where \kbd{conj} is
\kbd{groupelts\_conjclasses}$(\kbd{elts})$ and \kbd{rep} is the attached
\kbd{conjclasses\_repr}.
