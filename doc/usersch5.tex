...
\fun{GEN}{FqC_to_FlxC}{GEN x, GEN T, ulong p}, converts coefficients in \kbd{Fq}
to coefficient in Flx, result being a column vector.

\fun{GEN}{FqV_to_FlxV}{GEN x, GEN T, ulong p}, converts coefficients in \kbd{Fq}
to coefficient in Flx, result being a row vector.

\fun{GEN}{FqM_to_FlxM}{GEN x, GEN T, ulong p}, converts coefficients in \kbd{Fq}
