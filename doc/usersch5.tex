...
The following two functions allow to solve many Chinese remainder problems
...
\fun{GEN}{ZV_chinesetree}{GEN T, GEN P} given $P$ a vector of integers
...
\kbd{ZV\_producttree}$(P)$ and $R$ by \kbd{ZV\_chinesetree}$(T,P)$.
