...
\fun{GEN}{numdivu}{ulong n}, returns the number of positive divisors of $n>0$.

\fun{ulong}{numdivu_fact}{GEN fa} same, where \kbd{fa} is \kbd{factoru(n)}.
...
\fun{long}{RgX_type}{GEN x, GEN y, GEN *ptp, GEN *ptpol, long *ptprec} returns
...
\fun{long}{RgM_type}{GEN x, GEN y, GEN *ptp, GEN *ptpol, long *ptprec} returns
...
\fun{GEN}{Flc_Flv_mul}{GEN x, GEN y, ulong p} multipiles the column vector $x$
...
\fun{GEN}{FpXn_mul}{GEN x, GEN y, GEN p} return $x\*y$.

\fun{GEN}{FpXn_sqr}{GEN x, GEN p} return $x^2$.
