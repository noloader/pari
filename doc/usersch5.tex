...
\kbd{a}. The coefficients of \kbd{P} and \kbd{Q} must be of type \typ{INT},
\typ{INTMOD} or \typ{FFELT} and compatible with \kbd{a}.

\fun{GEN}{FFX_sqr}{GEN P, GEN a} returns the square of the polynomial
\kbd{P} defined over the definition field of the \typ{FFELT}
\kbd{a}. The coefficients of \kbd{P} must be of type \typ{INT},
\typ{INTMOD} or \typ{FFELT} and compatible with \kbd{a}.
