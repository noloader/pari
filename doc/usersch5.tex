...
apply \kbd{Flx\_eval\_powers\_pre} to all the elements of \kbd{x}.

\subsec{\kbd{FlxM}} See \kbd{FpXM} operations.

\fun{ulong}{FlxM_eval_powers_pre}{GEN M, GEN y, ulong p, ulong pi}
apply \kbd{FlxC\_eval\_powers\_pre} to all the elements of \kbd{M}.
...
\fun{GEN}{ZM_ker_ratlift}{GEN x} returns \kbd{matker(x)}
