...
that $b \geq a \geq 0$. Uses a sive with primes up to $\sqrt{b}$.
...
\fun{GEN}{sd_intarry}{const char *v, long flag, const char *s}

\item return a \typ{VECSMALL} array of integers.
