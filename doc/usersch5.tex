...
approximation of the real roots of \kbd{P}. If \kbd{flag} is 2 returns the
number of roots. The argument \kbd{ab} specify the interval in which the roots
are searched. The default interval is $(-\infty,\infty)$. If \kbd{ab} is an
integer or fraction $a$ then the interval will be $[a,\infty)$. If \kbd{ab} is
a vector of two integers or fractions $a$ e $b$, the the interval will be
$[a,b]$.
