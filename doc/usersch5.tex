...
all the $\zeta(aj + b)$, where $j = 0, 1, \dots, N-1$, where $a\ge 0$
and $b > 1$ are real numbers (of arbitrary type, although \typ{INT} is
treated more efficiently). Assumes that $N \geq 1$.
