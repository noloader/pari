...
\fun{const char*}{gp_format_time1}{long t} format a delay of $t$ ms
suitable for \kbd{gp} output, with \kbd{timer} set, without a trailing
dot and newline.
...
the numerical derivative of order $n$ of the closure \kbd{code}.
