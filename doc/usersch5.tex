...
\fun{GEN}{FpXX_halve}{GEN x, GEN p} returns $z$ such that $2\*z = x$ modulo
$m$ assuming such $z$ exists.
...
\fun{GEN}{FpXQX_factor_squarefree}{GEN x, GEN T, GEN p} same output convention as
\kbd{FpX\_factor\_squarefree}. Assumes \kbd{p} is prime and \kbd{T} irreducible
in $\F_p[X]$.

\fun{GEN}{FqX_factor_squarefree}{GEN x, GEN T, GEN p} same but allow
$\kbd{T} = \kbd{NULL}$.
