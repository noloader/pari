...
\fun{GEN}{ZX_uspensky}{GEN P, long onlypos, long flag, long bitprec} let \kbd{P} be a
...
approximation of the real roots of \kbd{P}. If \kbd{onlypos} is non-zero, limit
the results to the non-negative roots.
