...
Only primitive characters are supported.
...
@eprog\noindent In the above, the polynomial variable (here \kbd{x}) represents
$\zeta_5 := \exp(2i\pi/5)$ and the two matrices given the images of
$s$ and $t$.
