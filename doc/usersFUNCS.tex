...
These spaces are initialized by the \kbd{mfinit} command and contain a basis of
modular forms, which is accessed by the function \kbd{mfbasis}; the elements of
...
at infinity $[a(0),a(1),...,a(n)]$ using the function \kbd{mfcoefs}. Modular
...
By default the data computed by~\kbd{algini} contains a~$\Z$-basis of a maximal
