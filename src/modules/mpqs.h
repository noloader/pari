...
{ /*       tol lp_scl     M   szFB  oA pmx1 1st  sti */
  ...
  { /*11*/ 0.8,   1,    920,    22,  3,   5},
  { /*12*/ 0.8,   1,    960,    24,  3,   5},
  { /*13*/ 0.8,   1,   1020,    26,  3,   5},
  { /*14*/ 0.8,   1,   1100,    29,  3,   5},
  { /*15*/ 0.8,   1,   1200,    32,  3,   5},
  { /*16*/ 0.8,   1,   1500,    35,  3,   5},
  { /*17*/ 0.8,   1,   1900,    40,  3,   5},
  { /*18*/ 0.8,   1,   2500,    60,  3,   5},
  { /*19*/ 0.8,   1,   3200,    80,  3,   5},
  { /*20*/ 0.8,   1,   4000,   100,  3,   5},
  { /*21*/ 0.8,   1,   4300,   100,  3,   5},
  { /*22*/ 0.8,   1,   4500,   120,  3,   5},
  { /*23*/ 0.8,   1,   4800,   140,  3,   5},
  { /*24*/ 0.8,   1,   5100,   160,  4,   7},
  { /*25*/ 0.8,   1,   5400,   180,  4,   7},
  { /*26*/ 0.9,   1,   5700,   200,  4,   7},
  { /*27*/ 1.12,  1,   6000,   220,  4,   7},
  { /*28*/ 1.17,  1,   6300,   240,  4,  11},
  { /*29*/ 1.22,  1,   6500,   260,  4,  11},
  { /*30*/ 1.30,  1,   6800,   325,  4,  11},
  { /*31*/ 1.33,  1,   7000,   355,  4,  13},
  { /*32*/ 1.36,  1,   7200,   375,  5,  13},
  { /*33*/ 1.40,  1,   7400,   400,  5,  13},
  { /*34*/ 1.43,  1,   7600,   425,  5,  17},
  { /*35*/ 1.48, 30,   7800,   550,  5,  17},
  { /*36*/ 1.53, 45,   8100,   650,  5,  17},
  { /*37*/ 1.60, 60,   9000,   750,  6,  19},
  { /*38*/ 1.66, 70,  10000,   850,  6,  19},
  { /*39*/ 1.69, 80,  11000,   950,  6,  23},
  /* around here, the largest prime in FB becomes comparable to M in size */
  { /*40*/ 1.69, 80,  12500,  1000,  6,  23},
  { /*41*/ 1.69, 80,  14000,  1150,  6,  23},
  { /*42*/ 1.69, 80,  15000,  1300,  6,  29},
  { /*43*/ 1.69, 80,  16000,  1500,  6,  29},
  { /*44*/ 1.69, 80,  17000,  1700,  7,  31},
  { /*45*/ 1.69, 80,  18000,  1900,  7,  31},
  { /*46*/ 1.69, 80,  20000,  2100,  7,  37},
  { /*47*/ 1.69, 80,  25000,  2300,  7,  37},
  { /*48*/ 1.69, 80,  27500,  2500,  7,  37},
  { /*49*/ 1.72, 80,  30000,  2700,  7,  41},
  { /*50*/ 1.75, 80,  35000,  2900,  7,  41},
  { /*51*/ 1.80, 80,  40000,  3000,  7,  43},
  { /*52*/ 1.85, 80,  50000,  3200,  7,  43},
  { /*53*/ 1.90, 80,  60000,  3500,  7,  47},
  { /*54*/ 1.95, 80,  70000,  3800,  7,  47},
  { /*55*/ 1.95, 80,  80000,  4100,  7,  53},
  { /*56*/ 1.95, 80,  90000,  4400,  7,  53},
  { /*57*/ 2.00, 80, 100000,  4700,  8,  53},
  { /*58*/ 2.05, 80, 110000,  5000,  8,  59},
  { /*59*/ 2.10, 80, 120000,  5400,  8,  59},
  { /*60*/ 2.15, 80, 130000,  5800,  8,  61},
  { /*61*/ 2.20, 80, 140000,  6100,  8,  61},
  { /*62*/ 2.25, 80, 150000,  6400,  8,  67},
  { /*63*/ 2.39, 80, 160000,  6700,  8,  67},
  { /*64*/ 2.30, 80, 165000,  7000,  8,  67},
  { /*65*/ 2.31, 80, 170000,  7300,  8,  71},
  { /*66*/ 2.32, 80, 175000,  7600,  8,  71},
  { /*67*/ 2.33, 80, 180000,  7900,  8,  73},
  { /*68*/ 2.34, 80, 185000,  8200,  8,  73},
  { /*69*/ 2.35, 80, 190000,  8600,  8,  79},
  { /*70*/ 2.36, 80, 195000,  8800,  8,  79},
  { /*71*/ 2.37, 80, 200000,  9000,  9,  79},
  { /*72*/ 2.38, 80, 205000,  9250,  9,  83},
  { /*73*/ 2.41, 80, 210000,  9500,  9,  83},
  { /*74*/ 2.46, 80, 220000,  9750,  9,  83},
  { /*75*/ 2.51, 80, 230000, 10000,  9,  89},
  { /*76*/ 2.56, 80, 240000, 10500,  9,  89},
  { /*77*/ 2.58, 80, 250000, 11200,  9,  89},
  { /*78*/ 2.60, 80, 260000, 12500,  9,  89},
  { /*79*/ 2.63, 80, 270000, 14000,  9,  97},
  { /*80*/ 2.65, 80, 280000, 15500,  9,  97},
  { /*81*/ 2.72, 80, 300000, 17000,  9,  97},
  { /*82*/ 2.77, 80, 320000, 18500,  9, 101},
  { /*83*/ 2.82, 80, 340000, 20000, 10, 101},
  { /*84*/ 2.84, 80, 360000, 21500, 10, 103},
  { /*85*/ 2.86, 80, 400000, 23000, 10, 103},
  { /*86*/ 2.88, 80, 460000, 24500, 10, 107},
  ...
  { /*87*/ 2.90, 80, 520000, 26000, 10, 107},
  { /*88*/ 2.91, 80, 580000, 27500, 10, 109},
  { /*89*/ 2.92, 80, 640000, 29000, 10, 109},
  { /*90*/ 2.93, 80, 700000, 30500, 10, 113},
  ...
  {/*100*/ 3.8, 90, 3500000, 51000, 10, 133},
