...
{ /*       tol lp_scl     M   szFB  oA pmx1 1st  sti */
  {  /*9*/ 0.8,   1,    900,    20,  3,   5, 700,  80},
  { /*10*/ 0.8,   1,    900,    21,  3,   5, 700,  80},
  { /*11*/ 0.8,   1,    920,    22,  3,   5, 700,  60},
  { /*12*/ 0.8,   1,    960,    24,  3,   5, 700,  60},
  { /*13*/ 0.8,   1,   1020,    26,  3,   5, 700,  60},
  { /*14*/ 0.8,   1,   1100,    29,  3,   5, 700,  60},
  { /*15*/ 0.8,   1,   1200,    32,  3,   5, 600,  80},
  { /*16*/ 0.8,   1,   1500,    35,  3,   5, 600,  80},
  { /*17*/ 0.8,   1,   1900,    40,  3,   5, 600,  80},
  { /*18*/ 0.8,   1,   2500,    60,  3,   5, 500, 100},
  { /*19*/ 0.8,   1,   3200,    80,  3,   5, 500, 100},
  { /*20*/ 0.8,   1,   4000,   100,  3,   5, 400, 100},
  { /*21*/ 0.8,   1,   4300,   100,  3,   5, 400, 100},
  { /*22*/ 0.8,   1,   4500,   120,  3,   5, 400, 100},
  { /*23*/ 0.8,   1,   4800,   140,  3,   5, 300, 100},
  { /*24*/ 0.8,   1,   5100,   160,  4,   7, 300, 100},
  { /*25*/ 0.8,   1,   5400,   180,  4,   7, 300, 100},
  { /*26*/ 0.9,   1,   5700,   200,  4,   7, 300, 100},
  { /*27*/ 1.12,  1,   6000,   220,  4,   7, 300, 100},
  { /*28*/ 1.17,  1,   6300,   240,  4,  11, 300, 100},
  { /*29*/ 1.22,  1,   6500,   260,  4,  11, 300, 100},
  { /*30*/ 1.30,  1,   6800,   325,  4,  11, 200, 100},
  { /*31*/ 1.33,  1,   7000,   355,  4,  13, 200, 100},
  { /*32*/ 1.36,  1,   7200,   375,  5,  13, 200, 100},
  { /*33*/ 1.40,  1,   7400,   400,  5,  13, 200, 100},
  { /*34*/ 1.43,  1,   7600,   425,  5,  17, 200, 100},
  { /*35*/ 1.48, 30,   7800,   550,  5,  17, 200, 100},
  { /*36*/ 1.53, 45,   8100,   650,  5,  17, 200, 100},
  { /*37*/ 1.60, 60,   9000,   750,  6,  19, 200, 100},
  { /*38*/ 1.66, 70,  10000,   850,  6,  19, 200, 100},
  { /*39*/ 1.69, 80,  11000,   950,  6,  23, 200, 100},
  /* around here, the largest prime in FB becomes comparable to M in size */
  { /*40*/ 1.69, 80,  12500,  1000,  6,  23, 200, 100},
  { /*41*/ 1.69, 80,  14000,  1150,  6,  23, 100, 100},
  { /*42*/ 1.69, 80,  15000,  1300,  6,  29, 100, 100},
  { /*43*/ 1.69, 80,  16000,  1500,  6,  29, 100, 100},
  { /*44*/ 1.69, 80,  17000,  1700,  7,  31, 100, 100},
  { /*45*/ 1.69, 80,  18000,  1900,  7,  31, 100, 100},
  { /*46*/ 1.69, 80,  20000,  2100,  7,  37, 100, 100},
  { /*47*/ 1.69, 80,  25000,  2300,  7,  37, 100, 100},
  { /*48*/ 1.69, 80,  27500,  2500,  7,  37, 100, 100},
  { /*49*/ 1.72, 80,  30000,  2700,  7,  41, 100, 100},
  { /*50*/ 1.75, 80,  35000,  2900,  7,  41, 100, 100},
  { /*51*/ 1.80, 80,  40000,  3000,  7,  43, 100, 100},
  { /*52*/ 1.85, 80,  50000,  3200,  7,  43, 100, 100},
  { /*53*/ 1.90, 80,  60000,  3500,  7,  47, 100, 100},
  { /*54*/ 1.95, 80,  70000,  3800,  7,  47, 100, 100},
  { /*55*/ 1.95, 80,  80000,  4100,  7,  53, 100, 100},
  { /*56*/ 1.95, 80,  90000,  4400,  7,  53, 100,  80},
  { /*57*/ 2.00, 80, 100000,  4700,  8,  53, 100,  80},
  { /*58*/ 2.05, 80, 110000,  5000,  8,  59, 100,  80},
  { /*59*/ 2.10, 80, 120000,  5400,  8,  59, 100,  80},
  { /*60*/ 2.15, 80, 130000,  5800,  8,  61, 100,  80},
  { /*61*/ 2.20, 80, 140000,  6100,  8,  61, 100,  80},
  { /*62*/ 2.25, 80, 150000,  6400,  8,  67, 100,  60},
  { /*63*/ 2.39, 80, 160000,  6700,  8,  67, 100,  60},
  { /*64*/ 2.30, 80, 165000,  7000,  8,  67, 100,  60},
  { /*65*/ 2.31, 80, 170000,  7300,  8,  71, 100,  60},
  { /*66*/ 2.32, 80, 175000,  7600,  8,  71, 100,  60},
  { /*67*/ 2.33, 80, 180000,  7900,  8,  73, 100,  60},
  { /*68*/ 2.34, 80, 185000,  8200,  8,  73, 100,  60},
  { /*69*/ 2.35, 80, 190000,  8600,  8,  79,  80,  60},
  { /*70*/ 2.36, 80, 195000,  8800,  8,  79,  80,  60},
  { /*71*/ 2.37, 80, 200000,  9000,  9,  79,  80,  60},
  { /*72*/ 2.38, 80, 205000,  9250,  9,  83,  50,  50},
  { /*73*/ 2.41, 80, 210000,  9500,  9,  83,  50,  50},
  { /*74*/ 2.46, 80, 220000,  9750,  9,  83,  50,  50},
  { /*75*/ 2.51, 80, 230000, 10000,  9,  89,  50,  50},
  { /*76*/ 2.56, 80, 240000, 10500,  9,  89,  50,  50},
  { /*77*/ 2.58, 80, 250000, 11200,  9,  89,  50,  50},
  { /*78*/ 2.60, 80, 260000, 12500,  9,  89,  50,  50},
  { /*79*/ 2.63, 80, 270000, 14000,  9,  97,  50,  40},
  { /*80*/ 2.65, 80, 280000, 15500,  9,  97,  50,  40},
  { /*81*/ 2.72, 80, 300000, 17000,  9,  97,  40,  40},
  { /*82*/ 2.77, 80, 320000, 18500,  9, 101,  40,  40},
  { /*83*/ 2.82, 80, 340000, 20000, 10, 101,  40,  40},
  { /*84*/ 2.84, 80, 360000, 21500, 10, 103,  40,  40},
  { /*85*/ 2.86, 80, 400000, 23000, 10, 103,  40,  30},
  { /*86*/ 2.88, 80, 460000, 24500, 10, 107,  40,  30},
  ...
  { /*87*/ 2.90, 80, 520000, 26000, 10, 107,  40,  30},
  { /*88*/ 2.91, 80, 580000, 27500, 10, 109,  40,  30},
  { /*89*/ 2.92, 80, 640000, 29000, 10, 109,  40,  30},
  { /*90*/ 2.93, 80, 700000, 30500, 10, 113,  20,  20},
  { /*91*/ 2.94, 80, 770000, 32200, 10, 113,  20,  20},
  /* entries below due to Thomas Denny, never tested */
  { /*92*/ 3.6, 90, 2000000, 35000,  9, 113,  20,  20},
  { /*93*/ 3.7, 90, 2000000, 37000,  9, 113,  20,  20},
  { /*94*/ 3.7, 90, 2000000, 39500,  9, 127,  20,  20},
  { /*95*/ 3.7, 90, 2500000, 41500,  9, 127,  20,  20},
  { /*96*/ 3.8, 90, 2500000, 45000, 10, 127,  20,  20},
  { /*97*/ 3.8, 90, 2500000, 47500, 10, 131,  20,  20},
  { /*98*/ 3.7, 90, 3000000, 51000, 10, 131,  20,  20},
  { /*99*/ 3.8, 90, 3000000, 53000, 10, 133,  20,  20},
  {/*100*/ 3.8, 90, 3500000, 51000, 10, 133,  20,  20},
  {/*101*/ 3.8, 90, 3500000, 54000, 10, 139,  20,  20},
  {/*102*/ 3.8, 90, 3500000, 57000, 10, 139,  20,  20},
  {/*103*/ 3.9, 90, 4000000, 61000, 10, 139,  20,  20},
  {/*104*/ 3.9, 90, 4000000, 66000, 10, 149,  20,  20},
  {/*105*/ 3.9, 90, 4000000, 70000, 10, 149,  20,  20},
  {/*106*/ 3.9, 90, 4000000, 75000, 10, 151,  20,  20},
  {/*107*/ 3.9, 90, 4000000, 80000, 10, 151,  20,  20},
};
